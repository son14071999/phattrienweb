                    ...
                    <table id="example" class="table  responsive nowrap table-bordered" cellspacing="0" width="100%">
                      ...
                      <tbody>
                         <tr>
                          ...
                          <td>
                            <span class="sua" style="font-size: 22px"><a href="{{ URL::to('/admin/account'.'/'.$ac->id.'/edit') }}"><i class="fa fa-check-square-o" aria-hidden="true"></i></a></span>
                           {{--  <label class="sss" style="font-size: 20px; color: red">/</label> --}}
                            <span class="xoa" style="font-size: 22px"><a onclick="return confirm('Are you sure to delete?')" href="{{ URL::to('/delete'.'/') }}"><i class="fa fa-times" aria-hidden="true"></i></a></span>
