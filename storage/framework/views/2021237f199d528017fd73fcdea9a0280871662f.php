      ...
      <div class="row">
        ...
        <div class="col-lg-12 mt-md-2  mb-md-2">
          <div class="widgets-container">
            ...
            <form action="<?php echo e(URL::to('/admin/school')); ?>" name="themtc" class="themtieuchi" method="POST" enctype="multipart/form-data">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dragon\Desktop\phattrienweb\resources\views/admin/school/add_school.blade.php ENDPATH**/ ?>