    ...
    <table class="responstable">
        ...
        <?php for($i=0;$i<count($daihan);$i++): ?>
            <tr>
                ...
                <td><?php echo e($daihan[$i]->conLai_tt); ?></td>
                <td><?php echo e($daihan[$i]->conLai_dk); ?></td>
                <td><?php echo e($daihan[$i]->don_vi); ?></td>
                <td><?php echo e($daihan[$i]->ma_truong); ?></td>
                <td><?php echo e($daihan[$i]->thuong); ?></td>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dragon\Desktop\phattrienweb\resources\views/tieuchi1.blade.php ENDPATH**/ ?>